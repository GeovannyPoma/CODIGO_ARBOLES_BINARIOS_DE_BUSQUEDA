...
public class Vistaa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/arbolBB/logogris copia.png"))); // NOI18N
    ...
    private void botonInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonInsertarActionPerformed
        try {
            ...
            if (this.simulador.insertar(dato)) {
                JOptionPane.showMessageDialog(null, "Valor del nodo ingresado", " ...", 1);
